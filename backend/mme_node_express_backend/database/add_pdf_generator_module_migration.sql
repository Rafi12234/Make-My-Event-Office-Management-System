-- Creates pdf_documents / pdf_document_items for the PDF Generator module
-- (see scripts/addPdfGeneratorModuleMigration.js and
-- PDF_GENERATOR_MODULE_IMPLEMENTATION_GUIDE_UPDATED.md).
