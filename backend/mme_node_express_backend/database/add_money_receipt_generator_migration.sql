-- Money Receipt Generator module (Admin-only) — reference doc, mirrors the
-- PDF Generator module's migration convention. Actually applied by the
-- idempotent runner: scripts/addMoneyReceiptGeneratorMigration.js
