...
import AccountsAnimations from "../../../Accounts/frontend/components/AccountsAnimations";

// Shared chrome for the PDF Generator module's pages — mirrors
// Accounts/frontend/components/AccountsFormShell.jsx's structure/styling so
// the module feels native to the rest of the employee panel.
export default function PDFGeneratorShell({
  eyebrow,
  title,
  description,
  icon: Icon,
          ...
          <div className="flex min-h-18 items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0 border-l border-black/10 pl-3">
                <p className="truncate text-[10px] font-black uppercase tracking-[0.2em] text-black/70">{eyebrow}</p>
                <p className="truncate text-[10px] text-black/55">PDF Generator</p>
              </div>
            </div>
        ...
        <main className="px-3 py-5 sm:px-5 lg:px-8 lg:py-7">
          <section className={`mx-auto ${maxWidthClassName}`}>
            <div className="mm-fade mb-5">
              <BackButton to={backTo} title="Back" />
            </div>
