      ...
      <header className="sticky top-0 z-40 border-b border-[#d6d6d6]/50 bg-white/95 backdrop-blur-xl">
        <div className="flex min-h-18 items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          <div className="flex min-w-0 items-center gap-4">
            <Link to="/" className="hidden rounded-xl p-2 text-black/60 hover:bg-[#f4f4f4]/40 sm:block" title="Back to landing page">
              <ArrowLeft size={20} />
            </Link>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button onClick={switchEmployee} className="flex items-center gap-2 rounded-2xl border border-[#d6d6d6]/70 bg-white px-3 py-2.5 text-left transition hover:bg-[#f4f4f4]/30 sm:px-4">
              ...
              <div className="hidden sm:block">
                ...
                <p className="max-w-36 truncate text-[10px] text-black/50">Switch employee</p>
              </div>
